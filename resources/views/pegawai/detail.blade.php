...
@section('konten')
	@foreach($pegawai as $p)
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <label class="col-sm-4">{{ $p->pegawai_nama }} </label>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <label class="col-sm-4">{{ $p->pegawai_jabatan }} </label>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <label class="col-sm-4">{{ $p->pegawai_umur }} </label>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <label class="col-sm-4">{{ $p->pegawai_alamat }} </label>
            </div>
        </div>
